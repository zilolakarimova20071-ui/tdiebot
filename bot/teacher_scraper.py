...
async def debug_one_teacher(teacher_id: int) -> dict:
    ...
    to'g'ri ekanini tez tasdiqlash uchun foydali. Agar standart
    naqsh (font-size=85) bilan ism topilmasa, SVG ichidagi BARCHA
    matnli elementlarni (font-size'lari bilan) qaytaradi - shundan
    to'g'ri naqshni aniqlash mumkin."""
